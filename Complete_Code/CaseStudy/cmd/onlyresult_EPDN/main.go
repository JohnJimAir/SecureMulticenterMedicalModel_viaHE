...
func main() {
	...
	for i:=1;i<=3;i++{// Layer i
		for j:=1; j<=2; j++{// The j-th linear transformation
			weight_matrix_file_name := "../../model/sepsis/EPDN/W"+strconv.Itoa(i)+strconv.Itoa(j)+".txt"
			bias_vector_file_name := "../../model/sepsis/EPDN/b"+strconv.Itoa(i)+strconv.Itoa(j)+".txt"
